...
export const guides: GuideData[] = [
  {
    id: 1, slug: 'account-setup', level: 'beginner', category: 'Setup', stage: 'starter', showInPath: true, showInHighlight: false, showInPopularIssue: false, duration: 5,
  ...
  {
    id: 2, slug: 'obs-studio', level: 'beginner', category: 'Setup', stage: 'starter', showInPath: true, showInHighlight: true, showInPopularIssue: false, duration: 10,
  ...
  {
    id: 3, slug: 'kick-features', level: 'beginner', category: 'Setup', stage: 'amateur', showInPath: true, showInHighlight: false, showInPopularIssue: true, duration: 8,
  ...
  {
    id: 4, slug: 'chat-restrictions', level: 'beginner', category: 'Chat', stage: 'amateur', showInPath: false, showInHighlight: false, showInPopularIssue: false, duration: 8,
  ...
  {
    id: 5, slug: 'chatbot', level: 'intermediate', category: 'Tools & Bot', stage: 'amateur', showInPath: true, showInHighlight: true, showInPopularIssue: true, duration: 5,
  ...
  {
    id: 6, slug: 'moderator', level: 'intermediate', category: 'Chat', stage: 'amateur', showInPath: false, showInHighlight: false, showInPopularIssue: true, duration: 10,
  ...
  {
    id: 7, slug: 'discord-connector', level: 'intermediate', category: 'Tools & Bot', stage: 'pro', showInPath: true, showInHighlight: false, showInPopularIssue: true, duration: 10,
  ...
  {
    id: 8, slug: 'subscription-donation', level: 'intermediate', category: 'Monetization', stage: 'pro', showInPath: true, showInHighlight: true, showInPopularIssue: true, duration: 12,
  ...
  {
    id: 10, slug: 'kickbot-functions', level: 'intermediate', category: 'Tools & Bot', stage: 'pro', showInPath: false, showInHighlight: false, showInPopularIssue: false, duration: 10,
  ...
  {
    id: 11, slug: 'botrix-functions', level: 'intermediate', category: 'Tools & Bot', stage: 'pro', showInPath: false, showInHighlight: false, showInPopularIssue: false, duration: 10,
